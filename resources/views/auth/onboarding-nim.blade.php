            ...
            <form id="nimForm" action="{{ route('onboarding.nim.store') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="identitas_kampus" id="identitas_kampus" class="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all text-sm" placeholder="Contoh: 12345678" required>
                    </div>
