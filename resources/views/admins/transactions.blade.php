...
<div class="max-w-7xl mx-auto space-y-6 p-4 md:p-0">
    ...
    <div class="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden mb-6">
        <form method="GET" action="{{ route('admin.transactions') }}" class="px-6 py-5 border-b border-slate-200 flex flex-col sm:flex-row sm:justify-between sm:items-center bg-slate-50/50 flex-wrap gap-4">
