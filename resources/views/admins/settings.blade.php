            ...
            <div class="flex flex-col items-center gap-6 mb-6">
                ...
                <div class="w-full space-y-5">
                    <div>
                        ...
                        <input type="text" name="nama_lengkap" value="{{ Auth::user()->nama_lengkap }}" maxlength="50" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-slate-900 focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all font-medium">
