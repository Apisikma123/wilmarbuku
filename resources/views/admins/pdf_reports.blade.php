...
<head>
    <meta charset="UTF-8">
    <title>Laporan Transaksi - WilmarBuku</title>
    <style>
        ...
        .metrics-grid td { width: 33%; padding: 15px; border: 1px solid #d9e3f6; text-align: center; background-color: #f8f9ff; border-radius: 8px; }
        .metric-title { font-size: 11px; font-weight: bold; color: #707970; text-transform: uppercase; margin-bottom: 5px; }
        .metric-value { font-size: 24px; font-weight: bold; color: #121c29; margin: 0; }
...
<body>
    <div class="header">
        <h1>WilmarBuku - Laporan Transaksi</h1>
    ...
    <table class="metrics-grid">
        <tr>
            ...
            <td>
                <div class="metric-title">Transaksi Selesai</div>
                <div class="metric-value">{{ number_format($completedTransactions) }}</div>
            </td>
        </tr>
    </table>

    <div class="table-container">
        <h3 style="margin-bottom: 0;">Daftar Transaksi Terbaru (Max 100)</h3>
        <table>
            <thead>
                <tr>
                    <th>Kode Tracking</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="status-badge {{ $trx->status_pembayaran == 'Paid' ? 'status-paid' : 'status-unpaid' }}">
