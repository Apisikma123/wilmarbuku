...
<div class="max-w-7xl mx-auto space-y-6 p-4 md:p-0">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h2 class="text-2xl font-bold text-slate-900">Berhasil Tersedia</h2>
            <p class="text-slate-500 text-sm mt-1">Daftar buku yang sudah berhasil didonasikan dan tersedia di perpustakaan.</p>
        </div>
    </div>
    ...
    <div class="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-slate-200 bg-slate-50/50 flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-0">
            <h3 class="font-bold text-slate-900">Total {{ $books->count() }} Judul Buku Tersedia</h3>
            <span class="px-3 py-1 bg-green-100 text-green-800 font-bold text-xs rounded-full self-start sm:self-auto">Selesai</span>
        </div>
            ...
            <table class="w-full text-left text-sm whitespace-nowrap">
                <thead class="text-xs text-slate-500 uppercase bg-slate-50/50 border-b border-slate-200">
                    <tr>
                        ...
                        <th class="px-6 py-4 font-bold text-center">Stok Terkumpul</th>
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    @empty
                    <tr>
                        <td colspan="5" class="px-6 py-8 text-center text-slate-400">Belum ada buku yang berhasil tersedia.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
