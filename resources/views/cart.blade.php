                            ...
                            <div class="flex gap-5">
                                ...
                                <div class="flex-grow">
                                    ...
                                    <div class="flex flex-col sm:flex-row justify-between items-start gap-4 mb-5">
                                        <div class="flex gap-5">
                                            <div class="w-24 h-36 rounded-xl shadow-md flex-shrink-0 relative overflow-hidden group-hover:shadow-lg transition-shadow bg-gradient-to-br {{ $item['cover_image'] ?? 'from-primary to-primary-container' }} flex items-center justify-center p-2 text-center text-white">
                                                <h4 class="font-bold text-xs leading-tight tracking-tight">{!! str_replace(' ', '<br/>', $item['judul_buku']) !!}</h4>
