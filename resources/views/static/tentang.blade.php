...
<div class="px-6 md:px-12 xl:px-24 max-w-[1280px] mx-auto py-16 min-h-[60vh]">
    ...
    <div class="prose prose-lg text-on-surface-variant max-w-none">
        <p>WilmarBOOKS adalah platform donasi buku resmi dari Wilmar Business Indonesia Polytechnic. Kami menghubungkan donatur dengan perpustakaan kampus WBI — Anda pilih buku, kami pastikan sampai di rak.</p>
